<template>
	<v587-guide ref="guide" mode="darken" :maxHeight="734" @change="onChange" @done="onDone" @skip="onSkip">
			...
			return {
				steps: [{
					...
					},
					{
						...
						image: {
							url: "/uni_modules/v587-ui-sample/static/images/guide.png",
							style: {
								height: "240rpx",
								width: "320rpx"
							}
