<template>
	<view
		class="v587-loading"
		:class="[`v587-loading--${theme}`]"
		:style="{ height: size + 'px', width: size + 'px' }"
	>
		<!-- 菊花 -->
		<template v-if="theme == 'spin'">
			<view class="v587-loading__spin" v-for="i in 2" :key="i">
				<text
					class="v587-loading__spin-item"
					:style="[
						spinStyle,
						{
							top: 0,
 ...
 * @example <v587-loading></v587-loading>
 */
