<template>
	<view
		class="v587-swiper"
		:class="[`v587-swiper--${type}`, `v587-swiper--dot-${dotType}`]"
		:style="{ height }"
		@tap="onTap"
	>
		<swiper
		...
		<view class="v587-swiper__btn" v-if="arrow">
			<button class="v587-swiper__btn-prev" @tap="onPrev" v-if="isPrev">
				<i class="v587-icon-arrow-left"></i>
			</button>
			<button class="v587-swiper__btn-next" @tap="onNext" v-if="isNext">
				<i class="v587-icon-arrow-right"></i>
			</button>
		</view>
	</view>
</template>
 ...
 * @example <v587-swiper v-model="active" :list="list"></v587-slider>
 */
