<template>
	<view class="v587-captcha">
		<input
			class="v587-captcha__input"
			v-model="value2"
			type="number"
			:focus="focus"
			:maxlength="length"
		...
		<view class="v587-captcha__code">
			<view
				class="v587-captcha__item"
				:style="{
				...
				:key="index"
			>
				<text class="v587-captcha__value">{{ value2[index] }}</text>
				<view class="v587-captcha__cursor" v-if="value2.length == index && focus2"></view>
			</view>
		</view>
	</view>
</template>
 ...
 * @example <v587-captcha v-model="val"></v587-captcha>
 */
