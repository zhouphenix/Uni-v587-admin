						...
						<view v-for="(item2, index2) in item.children" :key="index2">
							...
							<slot :item="item2" :parent="item">
								<view class="cl-li__item" @tap="selectRow(item2)">
									<v587-avatar :src="item2.avatarUrl"></v587-avatar>
									<v587-text :margin="[0, 0, 0, 20]" :value="item2.name"></v587-text>
								</view>
							</slot>
						</view>
					</view>
...
<script>
import { last } from "../../js_sdk/v587-toolbox/common.js"
