<template>
	<view class="v587-action-sheet">
		...
		>
			...
			>
				<text class="v587-action-sheet__icon" :class="[item.icon]"></text>
				<text class="v587-action-sheet__label">{{ item.label }}</text>
			</button>

			<button
				class="v587-action-sheet__item v587-action-sheet__item--cancel"
				@tap="close('cancel')"
				v-if="showCancel"
			>
				{{ cancelText }}
 ...
 * @example <v587-action-sheet ref="action-sheet"></v587-action-sheet>
 */

export default {
	name: "v587-action-sheet",
