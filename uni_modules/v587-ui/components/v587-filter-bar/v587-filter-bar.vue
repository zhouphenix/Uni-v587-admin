<template>
	<view class="v587-filter-bar__wrap" :class="[isExpand ? 'is-expand' : '']">
		<view class="v587-filter-bar" :class="[classList]" :style="{ zIndex }">
			<slot></slot>
		</view>

		<!-- 遮罩层 -->
		<view class="v587-filter-bar__mask" @tap="close"></view>
	</view>
</template>
 ...
 * @event {Function} change v587-filter-item 数据发生改变时触发
 * @example 见教程
 */

export default {
	name: "v587-filter-bar",
