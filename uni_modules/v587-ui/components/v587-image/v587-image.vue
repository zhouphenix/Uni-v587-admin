<template>
	...
	>
		<slot name="placeholder" v-if="!src">
			<view class="v587-image__placeholder">
				<text class="v587-icon-image"></text>
			</view>
		</slot>

		<slot name="error" v-else-if="isError">
			<view class="v587-image__error"> 加载失败 </view>
		</slot>

		<image
			class="v587-image__target"
			:src="src"
			:mode="mode"
			:lazy-load="lazyLoad"
			:webp="webp"
...
<script>
import { isNumber, isArray, isString, parseRpx } from "../../js_sdk/v587-toolbox/common.js"
