<template>
	<view class="v587-upload-list" :class="[classList]">
		<!-- 加载框 -->
		<v587-loading-mask :loading="loading" text="上传图片中"></v587-loading-mask>
		...
		>
			<image class="v587-upload__target" v-show="url" :src="url" :mode="imageMode" />
			<text class="v587-upload__remove v587-icon-delete-fill" @tap.stop="remove(index)"></text>
		</view>
		...
		<view
			...
			@tap="choose()"
		>
			<text class="v587-upload__add v587-icon-plus"></text>
		</view>
	</view>
</template>

<script>
import { isArray, isString } from "../../js_sdk/v587-toolbox/common.js"
 ...
 * @example <v587-upload action="http://" />
 */
