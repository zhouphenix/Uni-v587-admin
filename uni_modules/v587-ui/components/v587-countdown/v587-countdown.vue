<template>
	<view class="v587-countdown">
		<template v-for="(item, index) in list">
			<view class="v587-countdown-item" :key="index" :style="[customStyle]" v-if="item.visible">
				<text class="v587-countdown__number" :style="[numberStyle]">{{ item.value }}</text>
				<text class="v587-countdown__splitor" :style="[splitorStyle]">{{
					item.splitor
				}}</text>
			</view>
		</template>

		<view class="v587-countdown-item" v-if="isMillisecond">
			<text class="v587-countdown__number">{{ millisecond }}</text>
		</view>
	</view>
</template>
