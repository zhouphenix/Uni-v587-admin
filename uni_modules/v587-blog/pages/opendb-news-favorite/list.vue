...
<template>
  <view>
    ...
    <view class="uni-container">
      <unicloud-db ref="udb" collection="opendb-news-favorite" field="article_id" :where="where" page-data="replace"
        ...
        <uni-table :loading="loading" :emptyText="error.message || '没有更多数据'" border stripe type="selection" @selection-change="selectionChange">
          <uni-tr>
              <uni-th align="center">article_id</uni-th>  
...
<script>
  import { enumConverter } from '@/uni_modules/v587-blog/js_sdk/validator/opendb-news-favorite.js';
