...
<uni-forms-item name="comment_content" label="评论内容" required>
  <uni-easyinput placeholder="评论内容" v-model="formData.comment_content" trim="right" />
</uni-forms-item>
...
<uni-forms-item name="reply_user_id" label="" required>
  <uni-easyinput placeholder="被回复的评论用户ID，comment_type为1时有效" v-model="formData.reply_user_id" />
</uni-forms-item>
<uni-forms-item name="reply_comment_id" label="" required>
...
<script>
  import { validator } from '@/uni_modules/v587-blog/js_sdk/validator/opendb-news-comments.js';
