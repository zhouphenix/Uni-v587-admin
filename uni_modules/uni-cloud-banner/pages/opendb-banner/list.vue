<template>
	<view>
		...
		<view class="uni-container">
			<unicloud-db ref="udb" collection="opendb-banner" field="bannerfile,open_url,title,sort,category_id,status,description"
				...
				<uni-table :loading="loading" :emptyText="error.message || '没有更多数据'" border stripe type="selection"
				 @selection-change="selectionChange">
					...
					<uni-tr v-for="(item,index) in data" :key="index">
						<uni-td align="center">
							<uni-file-picker v-if="item.bannerfile.fileType == 'image'" :value="item.bannerfile" :file-mediatype="item.bannerfile.fileType"
							 return-type="object" :imageStyles="imageStyles" readonly></uni-file-picker>
							<uni-link v-else :href="item.bannerfile.url"></uni-link>
						</uni-td>
						<uni-td align="center">
							<uni-link :href="item.open_url" :text="item.open_url"></uni-link>
						</uni-td>
