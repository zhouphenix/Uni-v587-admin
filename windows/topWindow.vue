<template>
	<view class="header">
		...
		<view class="navbar" :class="{'navbar-mini':!matchLeftWindow,'popup-menu':popupMenuOpened}">
			<view class="navbar-left pointer">
				<navigator class="logo" open-type="reLaunch" url="/">
					<image :src="logo" mode="heightFix" style="height: 50px;"></image>
					<text>{{appName}}</text>
				</navigator>
		...
		<uni-popup ref="quickTipsPopup" type="center">
			<view class="uni-header quick-tips">
				<view class="uni-group">
					<view class="uni-title quick-tips__title">快捷提示</view>
				</view>
			</view>
			<view class="quick-tips__content uni-scrollbar">
				<uni-table stripe>
					<uni-tr>
						<uni-th align="center">序号</uni-th>
						<uni-th align="center">组合键</uni-th>
						<uni-th align="center">描述</uni-th>
						<uni-th align="center">操作</uni-th>
					</uni-tr>
					<uni-tr v-for="(item, index) in hotkeys" :key="index">
...
<script>
	...
	export default {
		...
		methods: {
			...
			toggleFullscreen() {
				this.$fullscreen.toggle(this.$root.$el, {
					wrap: false,
